...
if uploaded_files:
    ...
    if config_files:
        ...
        # 用户选择要绘制的多列
        selected_columns = st.multiselect("选择要绘制的列", extracted_df.columns)
        ...
        if selected_columns:
            ...
            if start_datetime > end_datetime:
                ...
                # 图表样式设置
                line_width = st.slider("选择折线宽度", min_value=1, max_value=10, value=2)
                marker_size = st.slider("选择标记大小", min_value=5, max_value=20, value=6)
                font_size = st.slider("选择标注字体大小", min_value=8, max_value=20, value=12)
